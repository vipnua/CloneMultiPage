...
class CreateTableFingerprintBrowserDolphin extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mongodb_dataraw')->create('fingerprint_browser_dolphin', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fingerprint_browser_dolphin');
    }
}
