...
class CreateTableFingerprintBrowserGologin extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mongodb_dataraw')->create('fingerprint_browser_gologin', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fingerprint_browser_gologin');
    }
}
