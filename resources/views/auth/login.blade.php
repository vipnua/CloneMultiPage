        ...
        <div class="w-lg-500px p-10 p-lg-15 mx-auto">
            ...
            <form class="form w-100" action="{{ route('login') }}" method="POST">
                ...
                <div class="text-center mb-10">
                    <!--begin::Title-->
                    <h1 class="text-dark mb-3">Sign In to {{ config('app.name', 'MinhHoangJSC') }}</h1>
                    <!--end::Title-->
                    {{-- <!--begin::Link-->
                ...
                <div class="fv-row mb-10">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
					<input class="form-control form-control-lg form-control-solid @error('email') is-invalid @enderror" type="email" name="email" autocomplete="email" value="{{ old('email') }}" autofocus/>
                    <!--end::Input-->
                    @error('email')
