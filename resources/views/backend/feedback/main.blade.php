...
@section('header_title')
    <!--begin::Title-->
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">{{ $func ? $func->name : '' }}</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-dark">{{ $func ? $func->name : '' }}</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_modal_table">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-center min-w-125px">uu_id</th>
                                <th class="text-center min-w-125px">User_id</th>
                                <th class="text-center min-w-125px">Type</th>
                                <th class="text-center min-w-125px">Content</th>
                                <th class="text-center min-w-125px">Status</th>
                                <th class="text-center min-w-125px">Date_from</th>
                                <th class="text-center min-w-125px">Date_to</th>
                ...
                @include('backend.feedback.modal')
            </div>
            <!--end::Container-->
        </div>
        <!--end::Post-->
