<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="header-brand">
        <!--begin::Logo-->
        <a href="{{url('/')}}">
            <img alt="Logo" src="{{asset('assets/media/logos/logo-while-01.png')}}" class="h-25px h-lg-25px" />
        </a>
        <!--end::Logo-->
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="d-flex align-items-center" style="margin-right:10px;">
                            <!--begin::Menu- wrapper-->
                            <a href="#" class="btn btn-sm btn-icon btn-color-primary btn-active-icon-muted"
                                data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                                data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                                <span class="svg-icon svg-icon-1 notification-icon">
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Menu wrapper-->
                            <a id="logout_link" href="{{url('logout')}}" class="btn btn-sm btn-icon btn-color-danger btn-active-icon-muted"
                                data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                                data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
