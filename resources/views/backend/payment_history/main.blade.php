...
@section('header_title')
    <!--begin::Title-->
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Payment History</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div class="d-flex flex-column flex-wrap fw-bold"
                                                ...
                                                <label
                                                    ...
                                                    <input class="form-check-input" type="radio" name="status_search"
                                                           value="0" />
                                                    <span class="form-check-label text-gray-600">Not Charge</span>
                                                </label>
                                                <label
                                                    class="form-check form-check-sm form-check-custom form-check-solid mb-3">
                                                    <input class="form-check-input" type="radio" name="status_search"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_modal_table">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-center min-w-125px">Transaction ID</th>
                                <th class="text-center min-w-125px">User</th>
                                <th class="text-center min-w-125px">Plan</th>
                                <th class="text-center min-w-125px">Amount</th>
                                <th class="text-center min-w-125px">Status</th>
                                <th class="text-center min-w-125px">Employeee</th>
...
@section('link-script')
    ...
    @include('backend.payment_history.js')
@endsection
