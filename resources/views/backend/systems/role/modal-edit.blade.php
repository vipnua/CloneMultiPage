            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5">
                ...
                <tbody class="text-gray-600 fw-bold">
                    ...
                    @foreach ($groupermission as $item)
                        ...
                        <tr>
                            <!--begin::Label-->
                            <td class="text-gray-800">{{ $item->name }}<i class="fas fa-exclamation-circle ms-1 fs-7"
                                    ...
                                    @foreach ($item->permissions as $per)
                                        ...
                                        <label
                                            ...
                                            <input class="form-check-input" type="checkbox" value="{{ $per->id }}"
                                                name="permission[]" @if ($role->hasPermissionTo($per->id))
                                                    checked
                                                @endif/>
                                            <span
...
<div class="text-center pt-15">
    ...
    <button type="submit" class="btn btn-primary" data-kt-roles-modal-action="submit" id="kt_modal_add_modal_submit">
