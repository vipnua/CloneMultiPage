...
@section('header_title')
    <!--begin::Title-->
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Plan</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div class="d-flex flex-column flex-wrap fw-bold"
                                                ...
                                                <label
                                                    ...
                                                    <input class="form-check-input" type="radio" name="default_search"
                                                ...
                                                <label
                                                    ...
                                                    <input class="form-check-input" type="radio" name="default_search"
                                                           value="1"/>
                                                    <span class="form-check-label text-gray-600">Default</span>
                                                </label>
                                                <!--end::Option-->
                                                <!--begin::Option-->
                                                <label
                                                    ...
                                                    <input class="form-check-input" type="radio" name="default_search"
                                                           value="0"/>
                                                    <span class="form-check-label text-gray-600">Not Default</span>
                                                </label>
                                                <!--end::Option-->
                                            </div>
                                            <!--end::Options-->
...
{{--                                    <a href="{{route("bin.index")}}" class="btn btn-warning me-3"><i--}}
{{--                                            class="fas fa-trash"></i>Set Default Plan</a>--}}
{{--                                    <button type="button" class="btn btn-success" id="set_default_modal">Set Default {{ $func ? $func->name : '' }}</button>--}}
{{--                                @endcan--}}
                                <!--end::Trash-->
                            </div>
                            <!--end::Toolbar-->
...
{{--                                <th class="text-center min-w-125px">UUID</th>--}}
                                ...
                                <th class="text-center min-w-125px">Price</th>
                                <th class="text-center min-w-125px">Interval</th>
                                <th class="text-center min-w-125px">Profile</th>
                                <th class="text-center min-w-125px">Profile Share</th>
                                <th class="text-center min-w-125px">Status</th>
                                <th class="text-center min-w-125px">Describe</th>
